...
{
    class CoconutCalendarObjectsPage
    {
         
        public CoconutCalendarObjectsPage(IWebDriver driver)
        {
        ...
        [FindsBy(How = How.XPath, Using = ".//*[@id='office-details']/div[2]/div[1]/div[2]/ul/li[1]")]
